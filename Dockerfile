FROM netbirdio/netbird-server:0.76.0@sha256:3f08491f06864ba69bd6f596e99bb98647023b79edbcd0352ed928c899fd267a AS server
...
# Copy the multi-architecture combined server image published for NetBird v0.76.0.
...
# Copy the dashboard release current when NetBird v0.76.0 was published.
